...
public class ApiClient {
    ...
    private String basePath = "https://api.saas4saas.com";
    ...
    public ApiClient() {
        ...
        authentications.put("tenantid", new ApiKeyAuth("query", "tenantid"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.saas4saas.com
